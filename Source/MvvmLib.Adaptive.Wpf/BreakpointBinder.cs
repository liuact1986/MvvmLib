...
namespace MvvmLib.Adaptive
{
    ...
    public class BreakpointBinder : Control, INotifyPropertyChanged
    {
        ...
        {
            if (!jsonService.FileExists(path)) { throw new Exception("Json file \"" + path + "\" not found. Perhaps you have forgotten to set the json file as content in properties panel."); }
