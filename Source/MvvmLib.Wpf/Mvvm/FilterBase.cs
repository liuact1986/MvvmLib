...
namespace MvvmLib.Mvvm
{
    ...
    public abstract class FilterBase<T>
    {
        ...
        /// <summary>
        /// Creates the <see cref="FilterBase{T}"/>.
        /// </summary>
        public FilterBase()
        {
    ...
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class PropertyFilter<T> : FilterBase<T>
    {
        private readonly CultureInfo DefaultCulture = CultureInfo.InvariantCulture;
        private readonly PredicateBuilder builder;
    ...
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class CompositeFilter<T> : FilterBase<T>
    {
        private readonly List<FilterBase<T>> filters;
        /// <summary>
        /// The filters list.
        /// </summary>
        public IReadOnlyList<FilterBase<T>> Filters
        {
            get { return filters; }
        }
        ...
        {
            this.filters = new List<FilterBase<T>>();
        ...
        public void AddFilter(FilterBase<T> filter, bool refresh = false)
        {
        ...
        public bool RemoveFilter(FilterBase<T> filter)
        {
            bool removed = false;
