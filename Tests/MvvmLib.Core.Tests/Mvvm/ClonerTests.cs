...
namespace MvvmLib.Core.Tests.Mvvm
{
    ...
    public class ClonerTests
    {
        ...
        //[TestMethod]
        //public void Clones_ReadOnlyList()
        //{
        //    var cloner = GetService();
        //    var item = new MyItemWithReadOnlyList();
        //    item.MyItems.Add("A");
        //    item.MyItems.Add("B");

        //    var result = cloner.DeepClone<MyItemWithReadOnlyList>(item);
    ...
    public class MyItemWithReadOnlyList
    {

        public List<string> MyItems { get; set; }

        public IReadOnlyList<string> MyReadOnlyList => MyItems;

        public MyItemWithReadOnlyList()
        {
    ...
    public class MyItemWithClassIList
    {
        public MyIListOfString MyItems { get; set; }
    ...
    public class MyIListOfString : IList<string>
    {
    ...
    public class MyCollectionOfString : Collection<string>
    {
