...
namespace MvvmLib.Wpf.Tests.Navigation
{
    ...
    public class PropertyFilterTests
    {
        ...
        public void IsEqual_With_Inner_Object()
        {
            ...
            Assert.AreEqual(false, filter.Filter(new MyFilteredItem { MyInner = new InnerFilteredItem { MyInnerString = "A" } }));
            Assert.AreEqual(true, filter.Filter(new MyFilteredItem { MyInner = new InnerFilteredItem { MyInnerString = "B" } }));
        }
        ...
        public void Converts_Inner_Object_Value()
        {
            ...
            Assert.AreEqual(false, filter.Filter(new MyFilteredItem { MyInner = new InnerFilteredItem { MyInnerInt = 20 } }));
            Assert.AreEqual(true, filter.Filter(new MyFilteredItem { MyInner = new InnerFilteredItem { MyInnerInt = 10 } }));
        }
    ...
    public class MyFilteredItem
    {
        ...
        public InnerFilteredItem MyInner { get; set; }
        public List<string> MyStrings { get; set; }
    }

    public class InnerFilteredItem
    {
